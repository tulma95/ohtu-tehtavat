...
public class KauppaTest {
    ...
    @Test
    public void metodiaTilisiirtoKutsutaanOikeinKahdenEriOstoksenJalkeen() {
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "kerma", 7));
    ...
    @Test
    public void metodiaTilisiirtoKutsutaanOikeinKahdenSamanOstoksenJalkeen() {
    ...
    @Test
    public void metodiaTilisiirtoKutsutaanOikeinTyhjanOstonJalkeen() {
    ...
    @Test
    public void metodiAloitaAsiointiTekeeUudenViitenumeron() {
        when(varasto.saldo(1)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
    ...
    @Test
    public void metodiPoistaKoristaToimiiOikein() {
        when(varasto.saldo(1)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
